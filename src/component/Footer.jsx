      ...
      <footer className="bg-gray-700 text-white shadow-inner pt-10 pb-6">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between gap-8">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-200 leading-relaxed">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda laboriosam voluptatum veritatis voluptas, aliquam aut eos ducimus optio itaque explicabo?
            </p>
          </div>
        </div>
      </footer>
